(function (global, factory) {
  ...
  var ByteArrayInputStream_2 = ByteArrayInputStream;
  //# sourceMappingURL=ByteArrayInputStream.js.map

  var ByteArrayInputStream_1 = {
  ...
  var Base64DecodeInputStream_2 = Base64DecodeInputStream;
  //# sourceMappingURL=Base64DecodeInputStream.js.map

  var Base64DecodeInputStream_1 = {
  ...
  function createStringToBytes(unicodeData, numChars) {
    ...
    var unicodeMap = (function () {
      var bin = new Base64DecodeInputStream_1.Base64DecodeInputStream(
  ...
  var createStringToBytes_2 = createStringToBytes;
  //# sourceMappingURL=createStringToBytes.js.map

  var createStringToBytes_1 = {
    createStringToBytes: createStringToBytes_2,
  };

  var stringToBytes_SJIS_1 = createStringToBytes_1.createStringToBytes(
  ...
  var OutputStream_2 = OutputStream;
  ...
  var ByteArrayOutputStream_2 = ByteArrayOutputStream;
  //# sourceMappingURL=ByteArrayOutputStream.js.map

  var ByteArrayOutputStream_1 = {
  ...
  var Base64EncodeOutputStream_2 = Base64EncodeOutputStream;
  //# sourceMappingURL=Base64EncodeOutputStream.js.map

  var Base64EncodeOutputStream_1 = {
  ...
  var Base64 = (function () {
    ...
    Base64.encode = function (data) {
      ...
      try {
        var ostream = new Base64EncodeOutputStream_1.Base64EncodeOutputStream(
          bout,
        );
        try {
    ...
    Base64.decode = function (data) {
      var bout = new ByteArrayOutputStream_1.ByteArrayOutputStream();
      try {
        var istream = new Base64DecodeInputStream_1.Base64DecodeInputStream(
  ...
  var ErrorCorrectLevel_1 = createCommonjsModule(function (module, exports) {
    ...
    var ErrorCorrectLevel = exports.ErrorCorrectLevel;
    //# sourceMappingURL=ErrorCorrectLevel.js.map
  });
  var ErrorCorrectLevel_2 = ErrorCorrectLevel_1.ErrorCorrectLevel;
  ...
  var MaskPattern_1 = createCommonjsModule(function (module, exports) {
  ...
  var MaskPattern_2 = MaskPattern_1.MaskPattern;
  ...
  var QRCode = (function () {
    ...
    QRCode.createData = function (typeNumber, errorCorrectLevel, dataArray) {
      var rsBlocks = RSBlock_1.RSBlock.getRSBlocks(
        typeNumber,
        errorCorrectLevel,
      );
    ...
    QRCode.createBytes = function (buffer, rsBlocks) {
      ...
      for (var r = 0; r < rsBlocks.length; r += 1) {
        ...
        var rawPoly = new Polynomial_1.Polynomial(
          dcdata[r],
          rsPoly.getLength() - 1,
        );
  ...
  var QRCode$1 = QRCode_1.QRCode;

  var ErrorCorrectLevel = ErrorCorrectLevel_1.ErrorCorrectLevel;
  ...
  var Qr = /** @class */ (function (_super) {
    ...
    Qr.prototype.render = function (options) {
      ...
      wrapper.innerHTML =
        '<div style="display:flex;padding:15px;background:#fff;border-radius:10px"><div class="own-id-qr-code" style="margin-right:25px"></div><div style="display:flex;flex-direction:column;justify-content:space-between;flex:1;"><div><div style="font-family:\'SF Compact Text\',sans-serif;font-weight:bold;font-size:20px;line-height:32px;margin-bottom:4px;">' +
        options.title +
        '</div><div style="font-family:\'SF Compact Text\',sans-serif;font-weight:500;font-size:16px;line-height:24px;">' +
        options.subtitle +
        '</div></div><div><a href="https://ownid.com/" style="text-decoration:none;display:flex;justify-content:flex-end;"><span style="font-family:\'SF Pro Text\',sans-serif;font-weight:500;font-size:12px;line-height:24px;color:#ACACAC;margin-right:5px;">What is this?</span><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#030303"><path d="M4.16 8.322a1.25 1.25 0 0 1-.891-.371c-.492-.5-.492-1.286 0-1.776L9.108.368c.492-.5 1.3-.5 1.782 0s.492 1.286 0 1.776L5.052 7.95a1.25 1.25 0 0 1-.891.371zm7.116-1.286a1.25 1.25 0 0 1-.891-.371c-.492-.5-.492-1.286 0-1.776l1.662-1.657c.492-.5 1.3-.5 1.782 0s.492 1.286 0 1.776l-1.675 1.67a1.24 1.24 0 0 1-.878.358zm-7.154 7.132a1.25 1.25 0 0 1-.891-.371c-.492-.5-.492-1.286 0-1.776l4.242-4.23c.492-.5 1.3-.5 1.782 0s.492 1.286 0 1.776l-4.242 4.23a1.23 1.23 0 0 1-.891.371zm2.9 2.877a1.25 1.25 0 0 1-.891-.371c-.492-.5-.492-1.286 0-1.776l1.795-1.8c.492-.5 1.3-.5 1.782 0s.492 1.286 0 1.776l-1.795 1.8c-.24.252-.56.37-.9.37zm4.708-4.695a1.25 1.25 0 0 1-.891-.371c-.492-.5-.492-1.286 0-1.776l4.1-4.096c.492-.5 1.3-.5 1.782 0s.492 1.286 0 1.776l-4.1 4.096c-.24.252-.56.37-.9.37zM1.25 11.2A1.25 1.25 0 0 0 2.5 9.965a1.25 1.25 0 1 0-2.5 0 1.25 1.25 0 0 0 1.25 1.246zM9.906 20a1.25 1.25 0 0 1-.891-.371c-.492-.5-.492-1.286 0-1.776l5.944-5.925c.492-.5 1.3-.5 1.782 0s.492 1.286 0 1.776l-5.944 5.926a1.25 1.25 0 0 1-.891.371zm8.844-8.815a1.25 1.25 0 1 0-1.25-1.246 1.25 1.25 0 0 0 1.25 1.246z"/></svg></a></div></div></div>';
      ...
      var imgWrapper = wrapper.querySelector('.own-id-qr-code');
