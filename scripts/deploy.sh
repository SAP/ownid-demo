...
# Demo update
IMAGE_URI=$DOCKER_URL/$ENV/demo/ownid-demo_${TRAVIS_BUILD_NUMBER-}:$TRAVIS_COMMIT
...
# Demo 2 update
IMAGE_URI=$DOCKER_URL/$ENV/demo/ownid-demo-2_${TRAVIS_BUILD_NUMBER-}:$TRAVIS_COMMIT
...
# Demo 3 update
IMAGE_URI=$DOCKER_URL/$ENV/demo/ownid-demo-3_${TRAVIS_BUILD_NUMBER-}:$TRAVIS_COMMIT
...
# Demo 4 update
IMAGE_URI=$DOCKER_URL/$ENV/demo/ownid-demo-4_${TRAVIS_BUILD_NUMBER-}:$TRAVIS_COMMIT
