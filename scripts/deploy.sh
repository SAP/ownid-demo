...
docker tag ownid-client-app:latest2 $REPOSITORY_URI:$IMAGE_TAG2
...
kubectl -n=$ENV set image deployment/ownid-client-app-2-deployment ownid-client-app-2=$REPOSITORY_URI:$IMAGE_TAG2 --record
